...
export const products: Product[] = [
  ...
  },
  {
    id: "7",
    slug: "power-bank-65w",
    name: "Power Bank Basike 65W 20000mAh com Cabo Integrado",
    shortName: "Power Bank Basike 65W",
    category: "Gadgets & Eletrônicos",
    price: 189,
    originalPrice: 260,
    description: "Carregador portátil Basike de 20.000mAh com saída 65W USB-C, cabo USB-C integrado com lanyard, display digital de porcentagem e 8 proteções de segurança. Certificado ANATEL. Carrega notebooks, tablets e smartphones.",
    features: [
      "Capacidade real de 20.000mAh",
      "Saída USB-C 65W — carrega notebooks",
      "Entrada USB-C 40W (recarga rápida)",
      "Cabo USB-C integrado com lanyard",
      "Display digital de porcentagem",
      "8 proteções: sobrecarga, curto, temperatura e mais",
    ...
    deliveryDays: "5–8 dias úteis",
    reviews: [
      { author: "Leandro C.", rating: 5, comment: "Cabo integrado é genial, nunca fico sem cabo. Carregou meu notebook em viagem.", date: "08/05/2026" },
      { author: "Vitor H.", rating: 5, comment: "Display mostra a porcentagem exata. Qualidade Basike é diferente.", date: "19/04/2026" },
      { author: "Caio M.", rating: 5, comment: "ANATEL certificado, chegou rápido e bem embalado. Recomendo muito.", date: "02/04/2026" },
    ],
  },
  {
    id: "8",
  ...
  },
  {
    ...
    price: 219,
    originalPrice: 299,
    description: "Carregador portátil Liggi de altíssima capacidade com 50.000mAh, portas USB-A e USB-C, carregamento bidirecional e indicador LED. Carrega smartphones, tablets, notebooks e câmeras. Ideal para viagens longas e uso intensivo.",
    features: [
      "Capacidade de 50.000mAh — autonomia extrema",
      "Porta USB-C e USB-A para múltiplos dispositivos",
      "Carregamento bidirecional",
      "Indicador LED de nível de carga",
      "Proteção contra sobrecorrente, sobretensão e curto-circuito",
      "Cabo carregador incluso na caixa",
      "Compatível com smartphones, tablets, notebooks e câmeras",
    ],
    ...
    deliveryDays: "5–8 dias úteis",
    reviews: [
      { author: "Fábio A.", rating: 5, comment: "Carregou meu celular mais de 10 vezes numa viagem de 5 dias. Impressionante.", date: "20/05/2026" },
      { author: "Mariana C.", rating: 5, comment: "Levei para o exterior e não precisei de tomada por 4 dias. Vale muito.", date: "08/05/2026" },
      { author: "Leandro S.", rating: 4, comment: "Muito bom, só é um pouco pesado. Mas a capacidade compensa.", date: "25/04/2026" },
    ],
  },
  {
    id: "22",
